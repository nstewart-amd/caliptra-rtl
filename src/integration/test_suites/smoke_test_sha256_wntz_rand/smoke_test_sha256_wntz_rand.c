...
void main() {
    ...
    //                               0x00000000,
    //                               0x00000128};
    // uint32_t block_data_py_192_mb[] = {0xe9582015,
    //                                 0x64786adc,
    //                                 0xc962a588,
    //                                 0xe639df95,
    //                                 0x02d18f4d,
    ...
    //                                 0x00000000,
    //                                 0x000000b0};
    // uint32_t block_data_py_192[] = {0x89210352,
    //                                 0xda1557ff,
    //                                 0x22a3c2bc,
    //                                 0xe28e6aef,
    //                                 0x4f5c0e3d,
    ...
    //                                 0x5fd35490,
    //                                 0xa3f03ffe};
    // uint32_t expected_digest_py_192_mb[] = {0x5f958207,
    //                                      0xf0033cbd,
    //                                      0x6fe5e1c5,
    //                                      0x532b2c03,
    //                                      0xfe977073,
    ...
    //                                      0x00000000,
    //                                      0x00000000};
    // uint32_t expected_digest_py_192[] = {0xbfea0c11,
    //                                      0x6f87354f,
    //                                      0x025656ee,
    //                                      0x922ffe4e,
    //                                      0xdb0e9582,
    ...
    // Entry message
    VPRINTF(LOW, "----------------------------------\n");
    VPRINTF(LOW, " SHA256 wntz smoke test !!\n"             );
    VPRINTF(LOW, "----------------------------------\n");
    ...
    // sha256_block.data_size = 16;
    // for (int i = 0; i < sha256_block.data_size; i++)
    //     sha256_block.data[i] = block_data_py_192[i];

    // sha256_digest.data_size = 8;
    // for (int i = 0; i < sha256_digest.data_size; i++)
    //     sha256_digest.data[i] = expected_digest_py_192[i];
    SEND_STDOUT_CTRL(0xdd); //Forces block, w and n
    sha256_flow_wntz(SHA256_MODE_SHA_256);
    sha256_zeroize();
